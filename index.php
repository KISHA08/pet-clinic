    ...
    <div class="container" id="container">
        <div class="form-container sign-up">
            ...
            <form action="signup.php" method="post" onsubmit="return validateForm(this)">
                ...
                <!-- <input type="number" placeholder="ID" name="address" id="address" autocomplete="off"> -->
        ...
        <div class="form-container sign-in">
            ...
            <form action ="signin.php" method="post" >
                ...
                <input type="password" placeholder="Password" name="spassword" id="spassword" autocomplete="off">
