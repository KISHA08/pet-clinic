...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 wow fadeIn" data-wow-delay="0.1s">
        <a href="index.html" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h1 class="m-0 "><i class="far fa-hospital me-3 text-primary" ></i>BluePet</h1>
        </a>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item position-relative rounded overflow-hidden">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="Admin/product_img/<?php echo $productImage; ?>" alt="<?php echo $productName; ?>">
                        </div>
                        <div class="team-text bg-light text-center p-4">
                            <h5><?php echo $productName; ?></h5>
                            <p class="text-primary">RS <?php echo $productPrice; ?></p>
